...
public class ConsumerDemoWithShutdown {
    ...
    public static void main(String[] args) {
        ...
        properties.put("ssl.truststore.p", ""); // coletar no arquivo client
        ...
        log.info("Creating consumer thread: " +  mainThread.getName());
